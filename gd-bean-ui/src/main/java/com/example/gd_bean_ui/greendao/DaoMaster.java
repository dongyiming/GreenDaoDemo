...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        ...
        MenuSongDao.createTable(db, ifNotExists);
        SingerInfoDao.createTable(db, ifNotExists);
        SongInfoDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        ...
        MenuSongDao.dropTable(db, ifExists);
        SingerInfoDao.dropTable(db, ifExists);
        SongInfoDao.dropTable(db, ifExists);
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(MenuSongDao.class);
